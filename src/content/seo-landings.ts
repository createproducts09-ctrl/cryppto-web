...
export const seoLandings: SeoLanding[] = [
  ...
  },
  {
    ...
    description:
      "The required 2026 crypto research stack: CoinGecko, TradingView, DeFiLlama, Token Terminal, L2BEAT, Tokenomist, Etherscan, Dune, Messari, plus Alphora as the desk.",
    keywords: [
    ...
    hero: "A real desk needs CoinGecko or CMC, TradingView, DeFiLlama, Token Terminal, L2BEAT, an unlock calendar, Etherscan, and a place to decide. Alphora is that desk — not another data tab.",
    bullets: [
      "Use one tool per job: tape, DeFi, unlocks, chain, news, desk",
      "Required names: CoinGecko, DeFiLlama, Etherscan, Tokenomist",
      "Add Dune, Nansen, or Glassnode only when the thesis needs flows",
      "Alphora holds triage, briefs, and thesis P&L so tabs stay specialized",
    ],
    takeaways: [
      "No single product replaces CoinGecko + DeFiLlama + Etherscan.",
      "Unlocks (Tokenomist) and L2 risk (L2BEAT) are required, not optional.",
      "Alphora is the workflow layer on top of those sources.",
      "If a tool does not change Pass/Watch quality, drop it.",
    ],
    related: [
    ...
    comparison: {
      ...
      headers: ["Platform", "Job", "Best for"],
      rows: [
        ["Alphora Labs", "Desk", "Triage, AI briefs, public token pages, thesis baskets & P&L"],
        ["CoinGecko", "Market data", "Spot, categories, community metrics, history"],
        ["CoinMarketCap", "Market data", "Broad rankings and discovery"],
        ["TradingView", "Charts", "Levels, overlays, multi-exchange tape"],
        ["DeFiLlama", "DeFi", "TVL, fees, yields, chain comparables"],
        ["Token Terminal", "Fundamentals", "Protocol revenue and P/F style metrics"],
        ["L2BEAT", "L2 risk", "Rollup stages, TVL, and upgrade risk"],
        ["Tokenomist", "Tokenomics", "Unlocks, vesting, float vs FDV"],
        ["Messari", "Reports", "Long-form protocol research"],
        ["Etherscan", "On-chain", "Contracts, holders, raw transactions"],
        ["Dune", "On-chain", "Custom SQL dashboards"],
        ["Nansen", "On-chain", "Labeled wallets and smart-money flows"],
        ["Arkham", "On-chain", "Entity intel and investigations"],
        ["Glassnode", "On-chain", "BTC/ETH macros — SOPR, realized cap, flows"],
        ["CryptoQuant", "On-chain", "Exchange inflows and miner / stablecoin tape"],
        ["The Block", "News", "Market structure and institutional notes"],
      ],
    },
    sections: [
      {
      ...
      },
      {
        ...
        body: [
          "Required on day one: CoinGecko or CoinMarketCap for the tape, TradingView for levels, DeFiLlama for TVL and fees, Token Terminal for protocol revenue, L2BEAT if it is a rollup, Tokenomist for unlocks, Etherscan for the contract and holders, and Alphora to triage, brief, and track P&L. That is a working desk — not a bookmark folder.",
          "Add Dune when you need a custom dashboard, Nansen or Arkham when labeled wallets or entities matter, Glassnode or CryptoQuant for BTC/ETH macros, and Messari or Delphi when you want a long-form protocol report. News (The Block, CoinDesk) is context only — never a substitute for the unlock calendar.",
          "Review the stack quarterly. Cut anything you have not used to change a Pass/Watch call in thirty days. The best crypto research tools are the ones that still earn a seat.",
        ],
      },
    ],
    faqs: [
      ...
      {
        q: "What tools are actually required?",
        a: "Market tape (CoinGecko or CMC), charts (TradingView), DeFi/fundamentals (DeFiLlama + Token Terminal), unlocks (Tokenomist), L2 risk when relevant (L2BEAT), a chain explorer (Etherscan), and a desk (Alphora). Add Dune, Nansen, Arkham, or Glassnode only when the thesis needs flows or labels.",
      },
      {
        q: "Do I need Nansen or Arkham to start?",
        a: "Not on day one. Start with CoinGecko, DeFiLlama, Etherscan, and an unlock calendar. Add labeled-wallet or entity tools when a thesis specifically needs flow or concentration evidence.",
      },
      {
